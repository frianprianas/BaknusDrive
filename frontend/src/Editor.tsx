...
const Editor: React.FC = () => {
    ...
    // Using relative URL to stay within the same HTTPS context and avoid Mixed Content blocks.
    // The request will be handled by the Vite/Nginx proxy on the same domain.
